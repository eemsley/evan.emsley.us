...
function Home() {
  ...
  return (
    <div className="h-full w-full">
      ...
      >
        <div className="h-full w-full flex flex-row justify-center  text-slate-800 items-center">
          <div className="absolute left-0 w-1/4 flex p-4">
            <p className="text-3xl px-1  rounded-lg">Evan Emsley</p>
          </div>
      ...
      <div className="h-full w-full p-4 items-center flex flex-col scroll-smooth">
        <div
          id="Home"
          className="flex w-3/4 max-w-5xl flex-col justify-center items-center bg-slate-100 p-8"
        >
          ...
          <div className="w-full flex flex-row items-center">
            <div className="w-5/6">
              <p className="text-sm/normal text-slate-600 pr-12">
                ...
                the embrace of emerging technologies — each facet of my persona
                finds expression here. Enter this domain where the artistry of
                music intertwines with the precision of code, where physical
                vigor complements intellectual rigor, and where curiosity drives
                discovery. Here, the journey encompasses the synthesis of
                creativity and logic, resulting in a tapestry of innovation and
                exploration. Whether you seek to immerse yourself in the
                melodies that resonate from these strings, delve into the depths
                of programming and machine learning, draw inspiration for your
                fitness endeavors, or embark on a virtual odyssey through the
                realms of technology — rest assured, you have found a sanctuary
        ...
        <div
          id="Projects"
          className="flex w-full flex-col justify-center items-center mt-24"
        >
          <p className="text-5xl hover:text-6xl transition-all duration-1000 font-bold text-slate-600 pb-8">
            Projects
          </p>
          <div className="w-5/6 max-w-6xl flex flex-row flex-wrap">
        ...
        <div
          id="Resume"
          className="flex w-2/3 flex-col justify-center items-center mt-24"
        >
        ...
        <div
          id="About"
          className="flex w-3/4 flex-col justify-center items-center mt-24"
        >
          <p className="text-5xl hover:text-6xl transition-all duration-1000 font-bold text-slate-600 pb-4">
            More About Me
          </p>
